...
python main.py --config_file config/syn2cityscapes_v100_1/run_task/sl_1.yaml --resume_from pretrained_models/M_syn_at_warmup_v100.pth --pseudo_resume_from pretrained_models/G_syn_at_warmup_v100.pth --work_dir ${BASE_WORK_DIR}/sl_1
